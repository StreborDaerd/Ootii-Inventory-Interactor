...
{
	[TaskName("MC Wander")]
	[TaskDescription("Wander using the Unity NavMesh and Motion Controller.")]
	...
	public class MCWander : MCSeek
	{
		...
		{
			NavMeshHit hit;
			return NavMesh.SamplePosition(position, out hit, MCNavMeshInputSource.mNavMeshAgent.height * 0.5f, MCNavMeshInputSource.mNavMeshAgent.areaMask);
		}
	}
}